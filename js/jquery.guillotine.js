...
(function() {
  ...
  Guillotine = (function() {
    ...
    Guillotine.prototype._wrap = function(element) {
      var canvas, el, guillotine, height, img, paddingTop, width, _ref, _ref1, _ref2, _ref3;
      el = $(element);
      if (this.op.imageWidth && this.op.imageHeight) {
        _ref = [this.op.imageWidth, this.op.imageHeight], width = _ref[0], height = _ref[1];
      } else if (el.prop('tagName') === 'IMG') {
        img = document.createElement('img');
        img.src = el.attr('src');
        _ref1 = [img.width, img.height], width = _ref1[0], height = _ref1[1];
      } else {
        _ref2 = [el.width(), el.height()], width = _ref2[0], height = _ref2[1];
      }
      _ref3 = [width / this.op.width, height / this.op.height], this.width = _ref3[0], this.height = _ref3[1];
